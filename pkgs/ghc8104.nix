{ lib, stdenv, pkgsBuildTarget, targetPackages, writeTextFile
...
, # Whether to disable gold linker
  disableLdGold ? false
}:
...
let
  ...
  useLdGold = !disableLdGold && targetPlatform.isLinux && !(targetPlatform.useLLVM or false) && !targetPlatform.isMusl;
...
stdenv.mkDerivation (rec {
  ...
  patches = [
    # RISCV64 atomic fix
    ../patches/riscv64-ghc-atomic-fix.patch
